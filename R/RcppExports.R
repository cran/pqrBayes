...
BBL <- function(xx, y, ystar, W, maxSteps, hatBeta, hatAlpha, hatInvTauSq, invSigAlpha0, hatLambdaSqStar, aStar, bStar, alpha, gamma, progress) {
    .Call(`_pqrBayes_BBL`, xx, y, ystar, W, maxSteps, hatBeta, hatAlpha, hatInvTauSq, invSigAlpha0, hatLambdaSqStar, aStar, bStar, alpha, gamma, progress)
}

BBLSS <- function(xx, y, ystar, W, maxSteps, hatAlpha, hatBeta, hatInvTauSq, invSigAlpha0, hatPi, hatLambdaSq, aStar, bStar, alpha, gamma, sh1, sh0, progress) {
    .Call(`_pqrBayes_BBLSS`, xx, y, ystar, W, maxSteps, hatAlpha, hatBeta, hatInvTauSq, invSigAlpha0, hatPi, hatLambdaSq, aStar, bStar, alpha, gamma, sh1, sh0, progress)
}
...
BRBL <- function(xx, y, ystar, W, maxSteps, hatAlpha, hatBeta, hatV, hatSg, invSigAlpha0, hatEtaSq, xi1, xi2, r1, a, b, progress) {
    .Call(`_pqrBayes_BRBL`, xx, y, ystar, W, maxSteps, hatAlpha, hatBeta, hatV, hatSg, invSigAlpha0, hatEtaSq, xi1, xi2, r1, a, b, progress)
}

BRBLSS <- function(xx, y, ystar, W, maxSteps, hatAlpha, hatBeta, hatV, hatSg, invSigAlpha0, hatPi, hatEtaSq, xi1, xi2, r1, a, b, sh1, sh0, progress) {
    .Call(`_pqrBayes_BRBLSS`, xx, y, ystar, W, maxSteps, hatAlpha, hatBeta, hatV, hatSg, invSigAlpha0, hatPi, hatEtaSq, xi1, xi2, r1, a, b, sh1, sh0, progress)
}
