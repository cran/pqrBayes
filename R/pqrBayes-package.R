...
#' @description In this package, we implement Bayesian penalized quantile regression for the sparse linear model, binary LASSO, group LASSO and quantile varying coefficient (VC) models. 
