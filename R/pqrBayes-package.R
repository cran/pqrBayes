...
#' @description In this package, we implement Bayesian penalized quantile regression for a sparse linear model (with a continuous response), binary LASSO, group LASSO and quantile varying coefficient (VC) models. 
...
#' \tabular{rl}{
#' robust: \tab whether to fit a robust sparse quantile regression model (the sparse linear model \cr\tab with a continuous response, binary LASSO, group LASSO or varying coefficient models) \cr\tab or their non-robust counterparts. \cr\cr
...
#' model: \tab whether to fit a sparse linear model (with a continuous response), binary LASSO, group LASSO \cr\tab or a varying coefficient model.
#' }
#'
