...
#'
#' Calculate estimated regression coefficients with estimation accuracy from a sparse linear model (with a continuous response), binary LASSO, group LASSO and quantile VC models, respectively.
#'
